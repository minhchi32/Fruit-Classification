...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory('C:/Users/Admin/Desktop/Fruit Classification/train',
                                                 target_size=(100, 100),
                                                 batch_size=32,  # Total no. of batches
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory('C:/Users/Admin/Desktop/Fruit Classification/test',
                                            target_size=(100, 100),
                                            batch_size=32,
                                            class_mode='categorical')

classifier.fit_generator(training_set,
                         steps_per_epoch=5036/32,
                         epochs=10,
                         verbose = 1,
                         validation_data=test_set,
                         validation_steps=1683/32)

# step8 saving model

classifier.save("C:/Users/Admin/Desktop/Fruit Classification/model3.h5")
